...
// Local
use orion_runtime::{opaque::Block, AccountId, Balance, Nonce};
...
pub type Client = FullClient<orion_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		orion_runtime::api::dispatch(method, data)
	}

	fn native_version() -> NativeVersion {
		orion_runtime::native_version()
	}
}
