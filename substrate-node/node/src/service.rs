...
use sp_core::U256;
// Runtime
use orion_runtime::{opaque::Block, Hash, TransactionConverter};
	...
	Executor: NativeExecutionDispatch + 'static,
{
	...
	impl sp_inherents::InherentDataProvider for MockTimestampInherentDataProvider {
		async fn provide_inherent_data(
			...
			TIMESTAMP.with(|x| {
				*x.borrow_mut() += orion_runtime::SLOT_DURATION;
...
pub async fn build_full(
	...
	new_full::<orion_runtime::RuntimeApi, TemplateRuntimeExecutor>(
...
> {
	...
	let PartialComponents {
		...
		other,
		..
	} = new_partial::<orion_runtime::RuntimeApi, TemplateRuntimeExecutor, _>(
		config,
		eth_config,
